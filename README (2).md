...
4. Save.
5. Configure your local settings (see below).
6. Open DispatchTrack.
...
| Key                    | Purpose                                     |
| ---------------------- | -------------------------------------------- |
| `riverstoneJob`         | Active notification job                     |
| `riverstoneDeliveries`  | Cached route data                           |
| `riverstoneEmitrrQueue` | Queued messages                             |
| `cfg_agentName`         | Your name, inserted into templates          |
| `cfg_companyName`       | Your company name, inserted into templates  |
| `cfg_clientName`        | Client name, inserted into templates        |
| `cfg_clientWebsite`     | Client rescheduling website                 |
| `cfg_supportPhone`      | Support phone number shown to customers     |
